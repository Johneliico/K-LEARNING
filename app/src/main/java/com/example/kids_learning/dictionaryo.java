...
import com.example.kids_learning.Adapters.MeaningAdapter;
import com.example.kids_learning.Adapters.PhoneticsAdapter;
import com.example.kids_learning.Models.APIResponse;

public class dictionaryo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dictionaryo);
        ...
        progressDialog.show();
        RequestManager manager = new RequestManager(dictionaryo.this);
    ...
    private final OnFetchDataListener listener = new OnFetchDataListener() {
        ...
        public void onFetchData(APIResponse apiResponse, String message) {
            ...
            if (apiResponse==null){
                Toast.makeText(dictionaryo.this, "No data found!!!", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        public void onError(String message) {
          progressDialog.dismiss();
            Toast.makeText(dictionaryo.this, message, Toast.LENGTH_SHORT).show();
        }
    };
